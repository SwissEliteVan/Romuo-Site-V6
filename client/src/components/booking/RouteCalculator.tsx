...
export default function RouteCalculator() {
  ...
  return (
    <Card variant="glass" className="p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Button type="submit" fullWidth disabled={isCalculating} className="group">
          {isCalculating ? (
            ...
            <>
              Calculer le devis
              <DollarSign className="ml-2 h-5 w-5 group-hover:scale-110 transition-transform" aria-hidden="true" />
            </>
          )}
        </Button>
      </form>
      ...
      {error && (
        <div className="mt-4 p-4 bg-gradient-to-r from-red-500/10 to-red-600/5 border-l-4 border-red-500 text-red-200 shadow-lg shadow-red-500/10 animate-fadeInUp">
