        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12 px-4">
            <Card className="text-center">
              ...
              <a href="tel:+41760842089" className="text-[#d4af37] hover:underline text-base sm:text-lg font-semibold" aria-label="Appeler le 076 084 20 89">
                076 084 20 89
              </a>
            ...
            <Card className="text-center">
              ...
              <a href="mailto:contact@romuo-vtc.ch" className="text-[#d4af37] hover:underline text-sm sm:text-base break-all" aria-label="Envoyer un email à contact@romuo-vtc.ch">
