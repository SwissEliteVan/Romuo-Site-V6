      ...
      <Section spacing="lg">
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-[#999999] mb-8">
            ...
            <Card variant="outline" className="mb-8">
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-[#2d3748]">
                      <th className="text-left py-4 px-4 font-semibold text-[#ffffff]">Trajet</th>
                      <th className="text-right py-4 px-4 font-semibold text-[#ffffff]">Tarif indicatif</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      ...
                      <tr key={index} className="border-b border-[#2d3748]/50 last:border-0">
                        <td className="py-4 px-4 text-[#cccccc]">{item.route}</td>
              ...
              <div className="mt-6 p-4 bg-[#d4af37]/10 border-l-4 border-[#d4af37]">
